        ...
        <div class='p-6 max-w-sm mx-auto bg-white rounded-xl shadow-md flex-1 items-center space-x-4'>
          <div className='flex items-center content-center'>
            ...
            <div class='font-semibold text-center flex-auto items-center justify-center '>
              ...
              <Link to='/birthday'>
                <button class='px-5 py-2 my-5 text-sm text-purple-600 font-semibold rounded-full border border-purple-200 hover:text-white hover:bg-purple-600 hover:border-transparent focus:outline-none focus:ring-2 focus:ring-purple-600 focus:ring-offset-2 capitalize w-28'>
                  Start
                </button>
              </Link>
            </div>
        ...
        <div class='p-6 max-w-sm mx-auto bg-white rounded-xl shadow-md flex-1 items-center space-x-4'>
          <div className='flex'>
            ...
            <div class='font-semibold flex-auto text-center items-center justify-center'>
              ...
              <Link to='/marriage'>
                <button class='px-5 py-2 my-5 text-sm text-purple-600 font-semibold rounded-full border border-purple-200 hover:text-white hover:bg-purple-600 hover:border-transparent focus:outline-none focus:ring-2 focus:ring-purple-600 focus:ring-offset-2 w-28'>
                  Start
                </button>
              </Link>
            </div>
